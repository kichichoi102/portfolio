...
export const LoadingScreen = ({ progress }) => {
  return (
    <Html fullscreen>
      <div className='w-screen h-screen bg-white dark:bg-slate-800 flex justify justify-center'>
        <div className='flex flex-col justify-center items-center'>
          ...
          <p className='text-m font-medium text-white-100 dark:text-slate-400 text-center p-0.5'>{ProgressBarText[roundToNearestStep(Math.round(progress))]}</p>
        </div>
      </div>
    </Html>
  );
